...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Wplus_Powheg_MinNLO_With_Photos/WplusJetsToMuNu_svn3900_BugFix_TuneCP5_13TeV_powheg_MiNNLO_pythia8_photos.py nevts:30'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=1613
